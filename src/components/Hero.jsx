            ...
            <div className="flex-1 mb-10 md:mb-0 flex justify-center relative mt-[60px] lg:m-0">
                <div className="relative group">
                    <img
                        src={profilePic}
                        alt="Profile"
                        className="w-56 h-64 sm:w-72 sm:h-80 md:w-96 md:h-[420px] rounded-2xl object-cover shadow-lg border-2 border-teal-400 transform transition duration-500 group-hover:scale-105 group-hover:shadow-[0_0_25px_rgba(13,148,136,0.6)] group-hover:-translate-y-2"
                    />
